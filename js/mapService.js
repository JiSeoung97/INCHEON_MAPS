  ...
  const translateMenu = () => {
    ...
    menuBtn.forEach((menu, index) => {
      if (index == 0) {
        ...
        menu.innerHTML = language["boardingGate"];
      }
    });
    conEx.innerHTML =
      "• " +
  ...
  return {
    init: () => {
      ...
      try {
        ...
        const moveGateBtn =
          '<img id="moveBoardingGate" src="./images/boardingGate.png" style="height:30px; width:120px;margin-right:10px;margin-top:15px">';
